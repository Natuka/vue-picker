...
<template>
  <div id="h-picker">
    <div :transition="fade" class="area_ctrl" v-if="isOpened > 0" v-show="show">
      ...
      <div class="area_roll_mask">
        <div class="area_roll">
          <div>
            ...
            >
              <div class="tooth" v-for="(index,item) in pData1" :key="index">{{item.text}}</div>
            </div>
          ...
          <div v-if="columns > 1">
            <div
              ...
              val="5"
            >
              <div class="tooth" v-for="(index,item) in pData2" :key="index">{{item.text}}</div>
            </div>
            <div class="area_grid"></div>
          </div>
          <div v-if="columns > 2">
            <div
              ...
              val="5"
            >
              <div class="tooth" v-for="(index,item) in pData3" :key="index">{{item.text}}</div>
            </div>
            <div class="area_grid"></div>
          </div>
        </div>
